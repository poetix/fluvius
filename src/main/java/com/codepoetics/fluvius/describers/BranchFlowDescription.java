...
final class BranchFlowDescription implements FlowDescription {
    ...
    BranchFlowDescription(List<String> requiredKeyNames, String providedKeyName, FlowDescription defaultBranchDescription, Map<String, FlowDescription> branchDescriptions) {
